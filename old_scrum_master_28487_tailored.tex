...
\begin{center}
    ...
    \vspace{2pt}
    {\normalsize Scrum Master — Agile / SAFe | Leader en ingénierie de la qualité}\\
    \vspace{3pt}
...
% Injection ciblée de mots-clés prioritaires dans le résumé (vérifiables depuis le CV)
% Les mots-clés 'Agile', 'Scrum', 'priorisation', 'facilitation', 'amélioration continue' sont présents explicitement.
...
% Liste courte des mots-clés prioritaires (must_insert) — insérés littéralement en tête (impact ATS)
\skilltitle{Mots-clés prioritaires}
\begin{itemize}[leftmargin=10pt]
    \item Agile
    \item Scrum
    \item faciliter / facilitation
    \item amélioration continue
    \item priorisation
    \item résolution de problèmes
\end{itemize}

% Conserver les sections existantes (fusionnées pour lisibilité)
...
% Section ajoutée explicitement pour respecter l'exigence: insérer toutes les "competences_extracted" (orthographe préservée)
\section*{Compétences (extraites)}
\begin{itemize}[leftmargin=12pt]
    ...
    \item Travail en équipe / Travail d’équipe
    \item Souci du détail
    \item Influencer les autres
    \item Initiative
    \item Mobilisation
    \item Résilience
    \item Écoute
...
% Note: la section ci-dessus reprend exactement les éléments extraits (orthographe préservée) demandés par l'analyse.
...
\begin{itemize}[leftmargin=22pt]
    ...
    % \[NEEDS_VERIFICATION\] Suggestion: Facilite cérémonies Scrum multi-équipes pour assurer cadence et livraison de valeur.
\end{itemize}
...
AFCEPF-HENIX, France -- UML, Bases de données, Architectures distribuées, Big Data
